  ...
  <div style={{ padding: "20px", background: theme.card, borderRadius: "15px", border: "1px solid #333" }}>
    ...
    <textarea 
      ...
      style={{ 
        ...
        padding: "12px", borderRadius: "8px", fontSize: "14px", outline: "none", resize: "none" 
      }} 
    />
    <button 
      onClick={() => {
      ...
      style={{ 
        width: "100%", marginTop: "15px", padding: "12px", borderRadius: "8px", 
        background: theme.accent, color: "#000", fontWeight: "900", border: "none" 
      }}
    >
      SUBMIT
    </button>
